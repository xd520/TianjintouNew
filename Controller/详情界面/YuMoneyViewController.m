...
@interface YuMoneyViewController ()
{
...
@implementation YuMoneyViewController
...
- (void)viewDidLoad {
    ...
    dispatch_async(dispatch_get_global_queue( DISPATCH_QUEUE_PRIORITY_LOW, 0), ^{
        ...
        [[NetworkModule sharedNetworkModule] postBusinessReqWithParamters:paraDic tag:kBusinessTagGetJRappYyrgje owner:self];
...
- (void)slimeRefreshStartRefresh:(SRRefreshView *)refreshView
{
    ...
    [[NetworkModule sharedNetworkModule] postBusinessReqWithParamters:paraDic tag:kBusinessTagGetJRappYyrgjeAgain owner:self];
}
    ...
    if ([indexPath row] == [dataList count]) {
        ...
        if (cell == nil) {
            ...
            /*
             ...
             } else if ([[[dataList objectAtIndex:[indexPath row]] objectForKey:@"FID_YHDM"] isEqualToString:@"XYYH"]) {
             brandLabel.text = @"兴业银行";
            ...
            brandLabel.text = [[dataList objectAtIndex:[indexPath row]] objectForKey:@"NOTE"];
...
-(void)endPost:(NSString *)result business:(kBusinessTag)tag{
    ...
    if ([[jsonDic objectForKey:@"object"] isKindOfClass:[NSString class]]) {
        ...
        if (tag==kBusinessTagGetJRappYyrgje) {
        ...
        } else if (tag == kBusinessTagGetJRappYyrgjeAgain){
