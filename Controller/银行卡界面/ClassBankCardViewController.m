...
@interface ClassBankCardViewController ()
{
...
@implementation ClassBankCardViewController
...
- (void)viewDidLoad
{
    ...
    dispatch_async(dispatch_get_global_queue( DISPATCH_QUEUE_PRIORITY_LOW, 0), ^{
        ...
        [[NetworkModule sharedNetworkModule] postBusinessReqWithParamters:paraDic tag:kBusinessTagGetJRGetSupBankList owner:self];
...
- (void)slimeRefreshStartRefresh:(SRRefreshView *)refreshView
{
    NSMutableDictionary *paraDic = [[NSMutableDictionary alloc] init];
     ...
     [[NetworkModule sharedNetworkModule] postBusinessReqWithParamters:paraDic tag:kBusinessTagGetJRGetSupBankListAgain owner:self];
}
...
-(void)endPost:(NSString *)result business:(kBusinessTag)tag{
    ...
    if (tag==kBusinessTagGetJRGetSupBankList) {
    ...
    } else if (tag == kBusinessTagGetJRGetSupBankListAgain){
